...
function ft(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    iu ||
      ((iu = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, ef)))
}
function Dt(e) {
  function n(l) {
    return ft(l, e)
...
var lt = {
  ...
  Zo = ge(el),
  lf = V({}, el, { dataTransfer: 0 }),
  uf = ge(lf),
  of = V({}, Xt, { relatedTarget: 0 }),
  xl = ge(of),
  sf = V({}, lt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = ge(sf),
  cf = V({}, lt, {
...
var yf = V({}, Xt, {
  ...
  kf = ge(Sf),
  Ef = V({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cf = ge(Ef),
  _f = V({}, el, {
    deltaX: function (e) {
...
function ku(e, n, t, r) {
  var l = e.stateNode
  ;(l.props = t), (l.state = e.memoizedState), (l.refs = la), co(e)
  var u = n.contextType
  typeof u == 'object' && u !== null
    ? (l.context = Ce(u))
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[vu], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
ys = _o
gs = zn
var zd = { usingClientEntryPoint: !1, Events: [Gt, jn, rl, vs, hs, _o] },
  vt = {
